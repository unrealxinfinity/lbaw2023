...
Route::controller(ProjectController::class)->group(function () {
    ...
    Route::put('/api/projects/{id}/assign', 'promoteMemberToPL')->name('assign-project-leader');
    Route::put('/api/projects/{id}/demote', 'demotePLToMember')->name('demote-project-leader');
});
