...
@section('content')
    ...
    <section id="about" class="flex mobile:flex-row flex-col items-center px-3 py-2 mobile:mt-10">
            <img class="mobile:mr-4 mb-5 mobile:w-1/6 w-1/4" src="{{ URL('/images/steve-crafting.png') }}" alt="">
            <h2 class="rounded-lg p-2">MineMax is a project management tool to help Minecraft players better organize their Worlds and Projects.<br>
            <br>
