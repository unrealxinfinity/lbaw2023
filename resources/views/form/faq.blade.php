...
@elseif($operation == 'add')
    <form class="m-0 w-full" action="{{ route('add-faq')}}" method="POST">
        ...
        <fieldset class="relative flex flex-col items-end justify-center bg-lime rounded-lg w-full mt-10 mb-4 p-4 md:p-6">
            ...
            <button class="mx-3 mt-1 mb-2 w-full md:w-auto justify-center text-lg font-semibold text-lightlime cursor-pointer transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:shadow-outline" type="submit">Add</button>
        </fieldset>
    </form>
