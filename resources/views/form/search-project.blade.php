...
<div id="popupContainer" class="popup hidden z-20 bg-grey outline outline-white/20 outline-1 rounded fixed h-1/2 tablet:w-1/2 w-2/3 overflow-y-scroll top-[30%] tablet:left-[23%] left-[15%] justify-center">
    <h2 id="closePopUp" class="my-2 mx-5 cursor-pointer">&times;</h2>
    <div id="popup-content" class="p-2"></div>
</div>
